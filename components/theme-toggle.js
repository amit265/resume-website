...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative w-9 h-9 flex items-center justify-center rounded-full text-secondary hover:text-primary hover:bg-black/5 dark:hover:bg-white/5 hover:scale-105 transition-all duration-300 overflow-hidden group cursor-pointer"
